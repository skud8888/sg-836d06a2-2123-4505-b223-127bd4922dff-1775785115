...
export default function AboutPage() {
  return (
    <>
      <SEO
        title="About Us - GTS Training Centre"
        description="Learn about GTS Training Centre's mission, values, and commitment to excellence in training and education"
      />
      <Navigation />
      ...
      <main className="min-h-screen bg-background">
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">Why Choose GTS Training?</h2>
        ...
        <section className="py-20 bg-primary text-primary-foreground">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
              Join thousands of successful graduates who have transformed their careers with GTS Training
            </p>
